...
// マクロ定義
//=============================================================================
#define MAX_TEX	(7)		//読みこむテクスチャの最大数
...
void InitBG(void)
{
	...
	//テクスチャファイル名を格納する
	wsprintf(&BGName[0][0], "data\\TEXTURE\\bg000.jpg");		//タイトル背景
	wsprintf(&BGName[1][0], "data\\TEXTURE\\gameoverBG.jpg");		//ゲームオーバー背景
	wsprintf(&BGName[2][0], "data\\TEXTURE\\gameclearBG.jpg");		//ゲームクリア背景
	wsprintf(&BGName[3][0], "data\\TEXTURE\\castle.png");		//城のイラスト
	wsprintf(&BGName[4][0], "data\\TEXTURE\\tutorial.jpg");		//チュートリアル背景
	wsprintf(&BGName[5][0], "data\\TEXTURE\\scoreBG.jpg");		//スコア背景
	wsprintf(&BGName[6][0], "data\\TEXTURE\\sky.jpg");			//ゲーム背景
