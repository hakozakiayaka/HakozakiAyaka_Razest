...
Score g_Score;																			//構造体の変数
int g_nScore;																				//ゲームのスコア
...
void UpdateScore(void)
{
	...
	for (nCntScore = 0; nCntScore < DUGIT_NUMBER; nCntScore++)
	{
		...
		pVtx[2].pos = D3DXVECTOR3(870.0f + (50.0f * nCntScore), 75.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(920.0f + (50.0f * nCntScore), 75.0f, 0.0f);
		...
		//ポリゴンの色設定
		pVtx[0].col = D3DXCOLOR(0.5f, 0.7f, 0.2f, 1.0f);
		pVtx[1].col = D3DXCOLOR(0.5f, 0.7f, 0.2f, 1.0f);
		pVtx[2].col = D3DXCOLOR(0.5f, 0.7f, 0.2f, 1.0f);
		pVtx[3].col = D3DXCOLOR(0.5f, 0.7f, 0.2f, 1.0f);
