...
void InitBG(void)
{
	...
	//テクスチャファイル名を格納する
	wsprintf(&BGName[0][0], "data\\TEXTURE\\ranking2.png");			//ランキングの背景
	wsprintf(&BGName[1][0], "data\\TEXTURE\\gameclear.png");			//ゲームクリア
	wsprintf(&BGName[2][0], "data\\TEXTURE\\gameover.png");			//ゲームオーバー
	wsprintf(&BGName[3][0], "data\\TEXTURE\\kabegami.jpg");			//ランキング、タイトルの背景
