...
void InitLife(void)
{
	...
	//ライフの初期化
	 ...
	 //ライフが使われているかどうか
	 for (nCntLife = 0; nCntLife < PLAYER_LIFE; nCntLife++)
	 {
...
void UpdateLife(void)
{
	...
	for (nCntLife = 0; nCntLife < PLAYER_LIFE; nCntLife++)
	{
		...
		{
			//テクスチャの座標設定
			pVtx[0].pos = D3DXVECTOR3(0.0f + (60.0f * (PLAYER_LIFE - nCntLife - 1)), 5.0f , 0.0f);
			pVtx[1].pos = D3DXVECTOR3(50.0f + (60.0f * (PLAYER_LIFE - nCntLife - 1)), 5.0f , 0.0f);
			pVtx[2].pos = D3DXVECTOR3(0.0f + (60.0f * (PLAYER_LIFE - nCntLife - 1)), 55.0f , 0.0f);
			pVtx[3].pos = D3DXVECTOR3(50.0f + (60.0f * (PLAYER_LIFE - nCntLife - 1)), 55.0f , 0.0f);
		}
