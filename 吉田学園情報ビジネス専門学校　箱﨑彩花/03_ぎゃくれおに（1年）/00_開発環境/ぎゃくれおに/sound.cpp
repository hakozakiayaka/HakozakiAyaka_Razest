...
{
	{ "data/BGM/BGM_000.wav", -1 },				// タイトルBGM
	{ "data/BGM/BGM_003.wav", -1 },				// ゲーム中BGM
	{ "data/BGM/BGM_001.wav", 0 },				// リザルトBGM
	{ "data/BGM/黄昏.wav", -1},					// リザルトBGM
	{ "data/SE/開く2.wav", 0 },					// メニューを開く
	{ "data/SE/閉じる2.wav", 0 },				// メニューを閉じる
	{ "data/SE/決定.wav", 0 },					// 決定音
	{ "data/SE/移動音.wav", 0 },				// メニュー移動
	{ "data/SE/ニワトリ.wav", 0 },				// メニュー移動
	{ "data/SE/ぶつかる.wav", 0 },				// メニュー移動
	{ "data/SE/変身.wav", 0 },					// メニュー移動
};
