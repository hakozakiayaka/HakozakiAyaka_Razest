...
#define TEXTURE_NAME "data/TEXTURE/explosion001.png"		//テクスチャの名前
...
void UpdateExplosion(void)
{
	...
	for(nCntExplosion = 0; nCntExplosion < MAX_EXPLOSION; nCntExplosion++)
	{
		...
		{	//弾が使用されている
			...
			//爆発の座標設定
			pVtx[0].pos -= D3DXVECTOR3(0, 5, 0.0f);
			pVtx[1].pos -= D3DXVECTOR3(0, 5, 0.0f);
			pVtx[2].pos -= D3DXVECTOR3(0, 5, 0.0f);
			pVtx[3].pos -= D3DXVECTOR3(0, 5, 0.0f);
...
void SetExplosion(D3DXVECTOR3 pos, D3DXCOLOR col)
{
	...
	for(nCntExplosion = 0; nCntExplosion < MAX_EXPLOSION; nCntExplosion++)
	{
		if (g_aExplosion[nCntExplosion].bUse == false)
		{
			...
			//爆発の座標設定
			pVtx[0].pos = D3DXVECTOR3(g_aExplosion[nCntExplosion].pos.x - 10, g_aExplosion[nCntExplosion].pos.y - 10, 0.0f);
			pVtx[1].pos = D3DXVECTOR3(g_aExplosion[nCntExplosion].pos.x + 50, g_aExplosion[nCntExplosion].pos.y - 10, 0.0f);
			pVtx[2].pos = D3DXVECTOR3(g_aExplosion[nCntExplosion].pos.x - 10, g_aExplosion[nCntExplosion].pos.y + 50, 0.0f);
			pVtx[3].pos = D3DXVECTOR3(g_aExplosion[nCntExplosion].pos.x + 50, g_aExplosion[nCntExplosion].pos.y + 50, 0.0f);
