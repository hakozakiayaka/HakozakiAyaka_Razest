...
void MakeVertexTime(LPDIRECT3DDEVICE9 pDevice)
{
	...
	for (nCntTime = 0; nCntTime < MAX_TIME; nCntTime++)
	{
		pVtx[0].pos = D3DXVECTOR3(590.0f + (50.0f * nCntTime), 5.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(640.0f + (50.0f * nCntTime), 5.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(590.0f + (50.0f * nCntTime), 75.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(640.0f + (50.0f * nCntTime), 75.0f, 0.0f);
